...
"""\
	public:
		static ValueType get_result_type(IR::BytecodeClass::OpType op, ValueType left, ValueType right)
		{
...
(_, _, Any, Int, Float, Bool, Non, StrPtr, FuncPtr, ObjPtr, Err) =\
    re.findall(r'[a-zA-Z]+', value_types)

value_types = re.findall(r'[a-zA-Z]+', value_types)[2:]
value_type_to_index = dict(zip(value_types, range(0, len(value_types))))
# print(value_types)

(_, _, OpMove, OpLogicalOr, OpLogicalAnd, OpEqual, OpNotEqual, OpGreaterEqual, OpLessEqual, OpGreaterThan, OpLessThan, OpAdd, OpSub, OpMul, OpDiv, OpMod, OpNeg) =\
